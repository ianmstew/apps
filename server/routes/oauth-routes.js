...
var apiRoutes = function (app) {
  ...
  app.get('/oauth/auth/:client_id/', oauthController.auth);

  // External route called by client app to trade appToken + clientSecret for an accessToken
  app.get('/oauth/auth/:client_id/access_token/', oauthController.accessToken);
  ...
  // "Internal" route where user is redirected after calling /oauth/auth/:client_id.
